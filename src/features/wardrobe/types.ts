...
export interface ClothingItem { id:string; name:string; image:string; category:typeof categories[number]; color:string; season:string[]; occasion:string[]; brand?:string; favorite:boolean; createdAt:string }
